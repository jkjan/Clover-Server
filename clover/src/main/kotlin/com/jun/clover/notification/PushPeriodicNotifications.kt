...
import com.jun.clover.firebasetoken.FirebaseToken
...
class PushPeriodicNotifications {
    fun periodicNotificationJson(sampleData : List<FirebaseToken>) : String {
        val localDate = LocalDate.now()
        println(sampleData[0].token)
        //val sampleData = FirebaseTokenService().getToken()
//
//                listOf("eZIYqRhhKvM:APA91bEACg6DcEKbbMdsHdYDDZs2q65gfmy0Gb45AkHj0BkaBwOYPjXubXHQO1I_GuxldGrvbcDVTs0s_dHRORw5skND_4brFNq73bxINm1SyH6zBaNySWBQ2re9kY3_L-31ozQDth0P",
...
//                "exddgJstbpI:APA91bG_uMMtwgHFzhY4A26vZwDgIa62TQYN9b_KF6Uzkan5mtUxIWhMs-aCzb2tMmnmBwSZRvqeidLBaF5gkt9BkxA_F9IjuafQJS3AxdcPk3aIHsaPNpiJk2CdST1gvn9EM8rp3dif")
        ...
        for (i in sampleData.indices) {
            tokenList.add(sampleData[i].token)
        }
        val array = JSONArray()
